...
typedef void (*host_notify_request_payload_callback_t)(uint8_t, uint16_t);
typedef uint16_t (*host_notify_request_payload_and_get_reply_payload_callback_t)(uint8_t, uint16_t);
